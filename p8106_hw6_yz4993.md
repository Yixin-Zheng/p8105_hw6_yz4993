...
| log(beta_hat_0 \* beta_hat_1) |         1.965 |          2.059 |
...
``` r
proposed_model <- lm(bwt ~ gaweeks + blength + wtgain + bhead + smoken, data = birthweight_data)
...
![](p8106_hw6_yz4993_files/figure-gfm/regression-1.png)<!-- -->
